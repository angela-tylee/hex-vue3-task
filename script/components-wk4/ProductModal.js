export default {
  props: ['temp', 'updateProduct', 'isNew', 'createImages', 'delImages'],
  data() {
    return {
      // productModal: null,
      modalProduct: null
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-sm-4">
            ...
            <div>
              <button class="btn btn-outline-danger btn-sm d-block w-100" @click="delImages">
                刪除圖片
              </button>
            </div>
          </div>
          <div class="col-sm-8">
            ...
            <div class="row">
              <div class="mb-3 col-md-6">
                ...
                <input id="category" type="text" class="form-control" placeholder="請輸入分類" v-model="temp.category">
              </div>
              <div class="mb-3 col-md-6">
